...
export default function LandingHeader() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 border-b border-gray-200 bg-white flex items-center justify-between shadow-sm animate-navbar ${
        scrolled ? "py-1" : "py-2"
      }`}
    >
